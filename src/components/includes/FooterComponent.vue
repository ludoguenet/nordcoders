  ...
  >
    <div class="mx-auto max-w-7xl overflow-hidden py-20 px-6 sm:py-24 lg:px-8">
      <div class="mt-10 flex justify-center space-x-10">
        <a
            href="https://twitter.com/NordCoders"
...
11.616 0 006.29 1.84" />
        ...
        <a
            href="https://discord.com/invite/cuFxTjH"
            class="text-gray-400 hover:text-gray-500"
            target="_blank"
        >
      ...
      <p class="mt-10 text-center text-xs leading-5 text-gray-500">&copy; 2023 Nord Coders, Inc. All rights reserved.</p>
    </div>
  </footer>
</template>
